...
public class ReportdetailServiceImpl implements ReportdetailService {
     ...
     */
    @Override
    public List<Reportingotherexpenses> selectReportingotherexpensesBydispatchId(Integer dispatchId) {
        ReportdetailExample reportdetailExample = new ReportdetailExample();
        ReportdetailExample.Criteria reportdetailExampleCriteria = reportdetailExample.createCriteria();
        reportdetailExampleCriteria.andDispatchidEqualTo(dispatchId);
        List<Reportdetail> reportdetails = reportdetailMapper.selectByExample(reportdetailExample);
        ...
        return reportingotherexpensesList;
    }
     ...
     */
    @Override
    public List<Reportticket> selectReportticketInfoBydispatchId(Integer dispatchId) {
        ReportdetailExample reportdetailExample = new ReportdetailExample();
        ReportdetailExample.Criteria reportdetailExampleCriteria = reportdetailExample.createCriteria();
        reportdetailExampleCriteria.andDispatchidEqualTo(dispatchId);
        List<Reportdetail> reportdetails = reportdetailMapper.selectByExample(reportdetailExample);
    ...
    @Override
    public WechatReportdetailEatAndHotelParam getReportdetailInfoByDispatchIdAndByRiqi(Integer dispatchId, String Riqi) throws Exception {

        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyy-MM-dd");
        Date NowDate = simpleDateFormat.parse(Riqi);
        ReportdetailExample reportdetailExample = new ReportdetailExample();
        ReportdetailExample.Criteria reportdetailExampleCriteria = reportdetailExample.createCriteria();
        reportdetailExampleCriteria.andDispatchidEqualTo(dispatchId);
        List<Reportdetail> reportdetails = reportdetailMapper.selectByExample(reportdetailExample);
        ...
        WechatReportdetailEatAndHotelParam wechatReportdetailEatAndHotelParam = new WechatReportdetailEatAndHotelParam();
        Reportdetail reportdetail = reportdetails.get(0);
        ...
        if (reportaccommodations.size() != 0) {
            wechatReportdetailEatAndHotelParam.setReportaccommodation(reportaccommodations.get(0));
        }
        ...
        if (reportrestaurants.size() != 0) {
            wechatReportdetailEatAndHotelParam.setReportrestaurant(reportrestaurants.get(0));
        }

        return wechatReportdetailEatAndHotelParam;
    }
     ...
     */
    @Override
    public Reportdetail getReportdetailInfoByDispatchId(Integer dispatchId) {
        ReportdetailExample reportdetailExample = new ReportdetailExample();
        ReportdetailExample.Criteria reportdetailExampleCriteria = reportdetailExample.createCriteria();
        reportdetailExampleCriteria.andDispatchidEqualTo(dispatchId);
        List<Reportdetail> reportdetails = reportdetailMapper.selectByExample(reportdetailExample);
